            ...
            <div className="bg-[#DFDBF2] px-3 py-8 lg:mt-10 mt-5">
                ...
                <div className="xl:max-w-[1450px] md:max-w-[920px] mx-auto mt-3  px-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            [" A. Abuthaheer", "Sri Ramakrishna Engineering College", "India"],
                            ["Dr. Gabriel A.", " Sharda University","Uzbekistan"],
                            ["Deevi Radha Rani ", " VFSTR Deemed to be University","India"],                          
                            ["Dr Ashok Kumar", "Skyline university "," Nigeria"],                          
                            ["A.Karthikeyan ", "Sathy Rd, SNS Kalvi Nagar, ","India"],                          
                            ["Login Credentials ", "wasit university ","Iraq"],                          
                            ["Hua Qu ", "Tianjin Medical University "," China"],                          
                            ["B.Padmavathy ", " Anna University "," India"],                          
                            ["Bawar Mohammed Faraj ", " University of Halabja  "," Iraq"],                          
                            ["  Dr. Asma Sbeih", "Palestine Ahliya university ","Palestine"],                          
                            [" Johan Hendri Prasetyo", " Universitas Nusa Mandiri"," Indonesia"],                          
                            [" Zhao Qianyi", "Jinan University ","China"],                          
                            [" Vijay Anand R", "vellore institute of technology","India"],                          
                            ["Dr. D. KAYATHRI DEVI", " AMITY UNIVERSITY","Uzbekistan"],                          
                            ["Ziquan Feng", "Hanyang University","South Korea"],                          
                            [" Zonghai Wang", "Nanjing Agricultural University ","China"],                          
                            [" Maheshwari V", "Vellore institute of technology","India"],                          
                            [" Dr. M. Rajalakshmi", "Jyothi Engineering College ","India"],                          
                            ["Dr. Junaid Ahmed", "Zhengzhou University","China"],                          
                            [" P.Hemalatha", " IFET College of Engineering ","India"],                          
                            [" Twana A. Hamad", "Harran  University","Turkiye"],                          
                            [" Zhao Qianyi", "Jinan University","China"],                          
                            [" Brahim Issaoui", " Qassim University","Saudi Arabia"],                          
                            [" Qian Liu", " Krirk University","Thailand"],                          
                            [" Jhanghiz Syahrivar", " President University","Indonesia"],                          
                            [" Shakar Ahmed Aziz", "Duhok University","Iraq"],                          
                            [" Kushal Kanwar", "Shoolini University","India"],                          
