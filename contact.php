...
try {
    ...
    $mail->Password   = 'npwt ucuk vtdm etmo'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.icrais@gmail.com', 'ICRAIS Enquiry');
    $mail->addAddress('info.icrais@gmail.com', 'ICRAIS Enquiry');
    ...
    $replyMail->Username   = 'info.icrais@gmail.com';
    $replyMail->Password   = 'npwt ucuk vtdm etmo';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icrais@gmail.com', 'ICRAIS Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICRAIS 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICRAIS 2025 Team</p>
        </div>
    ';
