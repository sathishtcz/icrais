...
$required_fields = ['Firstname', 'Lastname','Email_Address', 'Mobile_Number', 'Message'];
$missing_fields = [];
...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.icrais@gmail.com';
    $mail->Password   = 'npwt ucuk vtdm etmo';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    $mail->setFrom('info.icrais@gmail.com', 'Contact Submission System');
    $mail->addAddress('info.icrais@gmail.com', 'Contact Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICRAIS Contact Submission';
    
    $mail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 800px;">
              <h2 style="color: #0B4F8E; border-bottom: 2px solid #287B86; padding-bottom: 10px;">Contact Submission</h2>
            
            <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                <tr style="background-color: #f8f9fa;">
                    <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold; width: 30%;">Firstname:</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">' . htmlspecialchars($_POST['Firstname']) . '</td>
                </tr>
                <tr>
                    <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold;">Lastname:</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">' . htmlspecialchars($_POST['Lastname']) . '</td>
                </tr>
                <tr>
                ...
                <tr style="background-color: #f8f9fa;">
                    ...
                    <td style="padding: 12px; border: 1px solid #ddd;">' . htmlspecialchars($_POST['Mobile_Number']) . '</td>
                </tr>
                <tr>
                    <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold;">Message:</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">' . htmlspecialchars($_POST['Message']) . '</td>
                </tr>
            </table>
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; font-size: 12px; color: #666;">
                <p>This email was automatically generated from the Contact Submission System.</p>
    ...
    if ($result) {
        echo 'Contact Submission sent successfully!';
    } else {
